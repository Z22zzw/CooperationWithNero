...
//        System.out.println("\n----- standard request -----");
        ...
        final ChatMessage systemMessage = ChatMessage.builder().role(ChatMessageRole.SYSTEM).content("你是当夏科技用来辅助用户进行AI写稿的人工智能助手，帮助用户为文稿润色和解决需求").build();
        final ChatMessage userMessage = ChatMessage.builder().role(ChatMessageRole.USER).content("我是谁？").build();
